...
edge_cases = {
    ...
    # Some have high packet rates (CDN, game server, backup) but few ports
...
# Attack 7: Brute Force — moderate rate, single port, many connections, short
n_brute = 800
brute_force = {
...
for col in ["packet_rate", "unique_ports", "avg_packet_size", "duration"]:
